...
def gen_split():
    endovis2018_train_path = "/home/eugenie/These/data/endovis2018/train"
    endovis2018_im_train_path = osp.join(endovis2018_train_path, 'images')
    train_names = os.listdir(endovis2018_im_train_path)

    endovis2018_val_path = "/home/eugenie/These/data/endovis2018/val"
    ...
    split_path = "/home/eugenie/These/UniMatch/splits/endovis2018/unsorted"
...
def split(num):   
    split_path = "/home/eugenie/These/UniMatch/splits/endovis2018/unsorted/1_" + str(num)
