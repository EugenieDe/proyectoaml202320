...
CUDA_VISIBLE_DEVICES=1 python train_net.py --eval-only --num-gpus 1 \
--config-file configs/endovis2018/1_8/SwinS.yaml \
OUTPUT_DIR output/endovis2018/inference/1_8/SwinS/new_transforms \
MODEL.WEIGHTS "/home/eugenie/These/proyectoaml202320/mask2former_unimatch/output/endovis2018/1_8/SwinS/new_transforms/model_best.pth"