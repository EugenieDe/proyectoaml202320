...
def train(cfg, local_rank, distributed):
    ...
    data_loader_labeled = make_data_loader(
        cfg,
        is_train=True,
    ...
    data_loader_unlabeled = make_data_loader(
        cfg,
        is_train=True,
        is_distributed=distributed,
        start_iter=arguments["iteration"],
    ...
    data_loader_unlabeled_mix = make_data_loader(
        cfg,
        is_train=True,
        is_distributed=distributed,
        start_iter=arguments["iteration"],
    ...
    loader = zip(data_loader_labeled, data_loader_unlabeled, data_loader_unlabeled_mix)
